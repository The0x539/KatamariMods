...
public sealed class Dega : MonoBehaviour {
    ...
    public void Awake() {
        ...
        this.handFix = this.GetComponent<HandFix>() ?? this.gameObject.AddComponent<HandFix>();

        this.handFix.cameraPosition = new(0.13f, -0.02f, 0);
        this.handFix.cameraScale = 0.725f;
